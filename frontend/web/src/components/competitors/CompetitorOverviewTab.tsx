// CompetitorOverviewTab — the legacy SEMrush-driven view extracted from
// CompetitorsPage.tsx so the page file can stay focused on tab/layout
// concerns. Renders the per-domain inner KPI strip, the competitor
// roster table, and the four gap-card pairs (topic + keyword;
// hygiene + content depth).
//
// Inputs are the same payload that backs `/api/v1/seo/competitor/` —
// see `CompetitorDashboard` in seoTypes.
...
export default function CompetitorOverviewTab({
  data,
}: {
