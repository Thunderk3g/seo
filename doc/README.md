...
6. [**Output Generation**](./OUTPUT_GENERATION.md) - Visualization selection and executive reporting.

---
*For general architecture details, see the root [ARCHITECTURE.md](../ARCHITECTURE.md).*
